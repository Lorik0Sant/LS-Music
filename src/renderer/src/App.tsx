      ...
      <main className="grid">
        ...
        <Section title="Twitch" desc="Войдите — и слушаем активацию награды за баллы канала.">
          ...
          <label className="toggle">
            ...
            />
            <span>Запросы остаются на модерации (можно вернуть баллы)</span>
          </label>
          <p className="muted small">
            Трек в обоих режимах встаёт в очередь и играет <b>сразу</b>. Разница: при
            включённой галке приложение <b>не подтверждает</b> награду автоматически —
            она висит в очереди наград Twitch, и модер/владелец на своё усмотрение жмёт
